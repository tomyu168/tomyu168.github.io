...
""")  # 开始写入 HTML 模板
    ...
    for chat_id in chat_ids:
        ...
        for message_div in top_limit_message_divs:
            ...
            for div in text_content_divs:
                ...
                if combined_text:
                    ...
                    print(f'target_div.html为{target_div.html}')
                    if target_div:
        ...
        messages_container = tab.ele(container1)
        soup = BeautifulSoup(messages_container.html, 'html.parser')
        # logfile = r'D:\hexoblog\source\telegram\1天30条的imgvideo\log.txt'
        # with open(logfile, 'a', encoding='utf-8') as file:
        #     file.write(str(soup))  # 或使用 soup.prettify()
...
# chat_ids = ['1001004069147', '1001157262013', '1001006939659', '1001433365344', '1001326223284', '1001036240821', '1001031569976', '1001157742664', '1001190116618', '1001101170442', '1001394050290']
