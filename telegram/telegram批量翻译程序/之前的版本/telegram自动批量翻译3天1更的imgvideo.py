...
def process_webpage(url_base, message_limit):
    # 指定输出文件路径
    output_file_path = r'D:\hexoblog\source\telegram\telegram_3dayOnceUpdate.html'
...
""")  # 开始写入 HTML 模板
    ...
    for chat_id in chat_ids:
        ...
        download_folder = r'D:\hexoblog\source\telegram\3天1更的imgvideo'
                ...
                for video in video_tags:  # 遍历每个视频
                    ...
                    if video_src and video_src.startswith('./progressive/document'):
                        ...
                        while retries < max_retries:
                            try:
                                # 设置下载路径和文件名
                                tab.set.download_path(r'D:\hexoblog\source\telegram\3天1更的imgvideo')  # 设置文件保存路径
        ...
        directory_path = "D:/hexoblog/source/telegram/3天1更的imgvideo"
...
chat_ids = ['1001508539275', '1001317297397', '1001157742664', '1001443119244', '1001433365344', '1001031569976', '1001157262013', '1001190116618', '1001003088750', '1001375124677']
